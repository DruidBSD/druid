...
################################################################################
#
# $Header: /cvsroot/druidbsd/druidbsd/druid/src/freebsd/repos/9.0-RELEASE/run_once/suj_setup.sh,v 1.1 2012/01/28 07:00:51 devinteske Exp $
#
# $Copyright: 2006-2012 Devin Teske. All rights reserved. $
#
# $Log: suj_setup.sh,v $
# Revision 1.1  2012/01/28 07:00:51  devinteske
