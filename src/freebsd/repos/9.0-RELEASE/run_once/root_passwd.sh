...
################################################################################
#
# $Header: /cvsroot/druidbsd/druidbsd/druid/src/freebsd/repos/9.0-RELEASE/run_once/root_passwd.sh,v 1.1 2012/01/28 07:00:46 devinteske Exp $
#
# $Copyright: 2006-2012 Devin Teske. All rights reserved. $
#
# $Log: root_passwd.sh,v $
# Revision 1.1  2012/01/28 07:00:46  devinteske
