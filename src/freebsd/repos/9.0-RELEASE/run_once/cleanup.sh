...
################################################################################
#
# $Header: /cvsroot/druidbsd/druidbsd/druid/src/freebsd/repos/9.0-RELEASE/run_once/cleanup.sh,v 1.1 2012/01/28 07:00:36 devinteske Exp $
#
# $Copyright: 2006-2012 Devin Teske. All rights reserved. $
#
# $Log: cleanup.sh,v $
# Revision 1.1  2012/01/28 07:00:36  devinteske
