...
################################################################################
#
# $Header: /cvsroot/druidbsd/druidbsd/druid/src/freebsd/repos/9.0-RELEASE/run_once/rsync_setup.sh,v 1.1 2012/01/28 07:00:49 devinteske Exp $
#
# $Copyright: 2006-2012 Devin Teske. All rights reserved. $
#
# $Log: rsync_setup.sh,v $
# Revision 1.1  2012/01/28 07:00:49  devinteske
