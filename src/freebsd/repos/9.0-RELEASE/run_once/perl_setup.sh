...
################################################################################
#
# $Header: /cvsroot/druidbsd/druidbsd/druid/src/freebsd/repos/9.0-RELEASE/run_once/perl_setup.sh,v 1.2 2012/09/03 21:47:19 devinteske Exp $
#
...
#
# Revision 1.1  2012/01/28 07:00:43  devinteske
